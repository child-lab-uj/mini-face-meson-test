...
// faces are to be detected in images) Can also optionally pass a grayscale image if it has already been computed to
// speed things up a bit
//================================================================================================================
bool DetectLandmarksInImage(
    const cv::Mat &rgb_image,
    CLNF &clnf_model,
    FaceModelParameters &params,
    cv::Mat &grayscale_image
...
// Return the current estimate of the head pose in world coordinates with camera at origin (0,0,0), but with rotation
// representing if the head is looking at the camera The format returned is [Tx, Ty, Tz, Eul_x, Eul_y, Eul_z]
