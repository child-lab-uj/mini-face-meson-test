...
class CCNF_neuron {
  ...
  public:
    ...
    // The im_dft, integral_img, and integral_img_sq are precomputed images for convolution speedups (they get set if
    // passed in empty values)
    void Response(
