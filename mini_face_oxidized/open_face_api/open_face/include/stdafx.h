...
// Instead of including cblas.h and f77blas.h (the definitions from OpenBLAS and other BLAS libraries differ, declare
// the required OpenBLAS functionality here)
#ifdef __cplusplus
extern "C" {
