...
//===========================================================================
// This is a modified version of openCV code that allows for precomputed dfts of templates and for precomputed dfts of
// an image _img is the input img, _img_dft it's dft (optional), _integral_img the images integral image (optional),
// squared integral image (optional), templ is the template we are convolving with, templ_dfts it's dfts at varying
// windows sizes (optional),  _result - the output, method the type of convolution
...
// The preference point allows for disambiguation if multiple faces are present (pick the closest one), if it is not set
// the biggest face is chosen
